...
CREATE DATABASE Tienda_Musical;
GO

DROP DATABASE IF EXISTS Tienda_Musical
GO 
...
CREATE TABLE Alquiler 
    (
     ...
     Oficina_Oficina_ID NUMERIC (28) NOT NULL 
    )
GO

ALTER TABLE Alquiler ADD CONSTRAINT Alquiler_PK PRIMARY KEY CLUSTERED (Id_Alquiler, Clientes_Id_Cliente, Clientes_Localizacion_Id_Localizacion)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
CREATE TABLE Factura_Alquiler 
    (
     ...
     Alquiler_Id_Cliente VARCHAR (10) NOT NULL , 
     Alquiler_Id_Localizacion INTEGER NOT NULL , 
     Metodo_Pago_id_Pago INTEGER NOT NULL 
    )
GO
...
CREATE TABLE Factura_Compra 
    (
     ...
     Compra_Id_Instrumento INTEGER NOT NULL , 
     Compra_Id_Cliente VARCHAR (10) NOT NULL , 
     Compra_Id_Localizacion INTEGER NOT NULL , 
     Metodo_Pago_id_Pago INTEGER NOT NULL 
    )
GO
...
CREATE TABLE Oficina 
    (
     ...
     Telefono VARCHAR (10) , 
     Localizacion_Id_Localizacion INTEGER NOT NULL , 
     Oficina_ID NUMERIC (28) NOT NULL IDENTITY NOT FOR REPLICATION 
    )
GO

ALTER TABLE Oficina ADD CONSTRAINT Oficina_PK PRIMARY KEY CLUSTERED (Oficina_ID)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE TARJETA ADD CONSTRAINT TARJETA_PK PRIMARY KEY CLUSTERED (Metodo_Pago_id_Pago)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Factura_Compra 
    ...
    ( 
     Compra_Id_Compra, 
     Compra_Id_Instrumento, 
     Compra_Id_Cliente, 
     Compra_Id_Localizacion
    ) 
    REFERENCES Compra 
    ( 
     Id_Compra , 
